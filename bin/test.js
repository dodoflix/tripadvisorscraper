...
(async () => {
    ...
    while (type !== "exit") {
        console.info("Types:\n" +
            "1: Teker teker otel bilgilerini çeker.\n" +
            "2: Verilen urldeki tüm otellerin bilgilerini çeker.\n" +
            "3: Teker teker yorum çeker.\n" +
            "4: Verilen urldeki tüm otellerin yorumlarını çeker.");
